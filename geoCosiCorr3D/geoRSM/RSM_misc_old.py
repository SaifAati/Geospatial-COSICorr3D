...
class HeightInterpolation:
    @staticmethod
    def get_h_from_DEM(geo_coords: List, h: float, demInfo: cRasterInfo, step=3):
        from geoCosiCorr3D.georoutines.georoutines import ConvCoordMap1ToMap2
        from geoCosiCorr3D.geoRSM.Interpol import Interpolate2D
        demCoord = ConvCoordMap1ToMap2(x=geo_coords[0],
                                       y=geo_coords[1],
                                       z=h,
        ...
        XdemMin, XdemMax, YdemMin, YdemMax = HeightInterpolation.chuck_DEM_subset(xdemPix=xdemPix,
                                                                                  ydemPix=ydemPix,
                                                                                  demInfo=demInfo,
                                                                                  step=step)
    ...
    @staticmethod
    def chuck_DEM_subset(xdemPix, ydemPix, demInfo: cRasterInfo, step=3):
