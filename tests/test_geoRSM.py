...
from geoCosiCorr3D.geoRSM.Spot_RSM import cSpot15, cSpot67
...
expected_model_classes.extend([cSpot67, cDigitalGlobe])
expected_model_classes.extend(2 * [cDigitalGlobe])
